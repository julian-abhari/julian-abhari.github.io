...
public class Plesiosaur extends NPC {
	private int color = new Colors(-1, 134, 145, 555).getColor();

	public Plesiosaur(Level level, String name, float x, float y, int mass) {
		super(level, name, x, y, mass);
		message = "I'm a pleasiasaurus. Pleased to meet you.";
		messageDelay = 3000;
	}
